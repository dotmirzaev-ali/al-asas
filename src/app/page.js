...
import { TopicSearch } from "./_components/TopicSearch";
...
const popularScholars = scholars.slice(0, 4);
      ...
      <main className="flex-1">
        ...
        >
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
            ...
            <div className="mt-10 flex w-full max-w-md flex-col gap-4 sm:max-w-none sm:flex-row sm:flex-wrap sm:items-stretch">
              <Link
                href="#start"
                className="inline-flex h-12 min-h-12 w-full shrink-0 items-center justify-center rounded-full bg-asas-green px-8 text-center text-sm font-semibold text-asas-white shadow-sm transition hover:bg-asas-green/90 sm:w-auto sm:min-w-[12rem]"
              >
                С чего начать
              </Link>
              <Link
        ...
        >
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              ...
              <Link
                href="/scholars"
                className="shrink-0 text-sm font-semibold text-asas-green underline-offset-4 hover:underline"
              >
                Все учёные
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 gap-10 text-sm sm:gap-16">
              <div>
                ...
                <ul className="mt-3 space-y-2 text-asas-ink/70">
                  <li>
                    <Link href="/scholars" className="hover:text-asas-green">
                      Учёные
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href="/#search" className="hover:text-asas-green">
                      Поиск
                    </Link>
                  </li>
                </ul>
